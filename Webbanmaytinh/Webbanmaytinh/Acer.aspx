<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acer.aspx.cs" Inherits="Webbanmaytinh.Acer" %>
...
<head runat="server">
    <title>Acer</title>
	 <link href="Style/acer.css" rel="stylesheet" />
</head>
<body>
	...
	<div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Acer.aspx"><strong>ACER</strong></a>
        </div>
    </div>
	<div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="acer1" runat="server">
                    <ItemTemplate>
